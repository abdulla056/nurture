...
export function Home() {
  return (
    <div className="flex flex-col bg-custom-gradient px-16 py-8 w-full h-full gap-16">
      ...
      <div className="flex flex-col justify-center gap-12 items-center" id="features">
        <span className="text-5xl text-white w-1/2 text-center">From predicting, to visualizing, to explaining</span>
        <Features/>
      </div>
    </div>
  );
